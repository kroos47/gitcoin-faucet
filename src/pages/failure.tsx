    ...
    <main>
      <div className="min-h-screen grid place-items-center">
        <div className="p-4 flex flex-col justify-center items-center">
          <span className="text-red-700 rounded-full bg-opacity-30 w-36">
          ...
          <h1 className="text-3xl text-center mt-4 mb-1">Oops! </h1>
          <p className="text-gray-600 mb-2">
            Your passport score is below the minimum (20). Go back to collect
            more stamps and then try again. For more info see the&nbsp;
            <a
